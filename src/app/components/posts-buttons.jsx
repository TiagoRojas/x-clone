...
export default function Buttons({postInfo, userInfo}) {
	const {id} = userInfo;
	...
	return (
		<div className="flex justify-between w-full">
			...
			<Button variant="faded" className="hover:bg-green-400/20 hover:text-green-600 p-2 rounded-full" onClick={() => updateDb('reposts')}>
				<IconRepeat />
				{/* <span>{postInfo.posts.reposts.length > 0 && postInfo.posts.reposts.length}</span> */}
			</Button>
